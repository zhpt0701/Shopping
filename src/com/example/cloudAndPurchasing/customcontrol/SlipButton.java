...
public class SlipButton extends View implements View.OnTouchListener{
    ...
    private void init(){//初始化
        //载入图片资源
        bg_on = BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher);
        bg_off = BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher);
        slip_btn = BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher);
        //获得需要的Rect数据
