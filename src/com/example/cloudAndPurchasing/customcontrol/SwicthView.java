 ...
 */
public class SwicthView extends View implements View.OnTouchListener {
    ...
    public void init(){
        //载入图片资源
        bg_on = BitmapFactory.decodeResource(getResources(), R.drawable.radiorieht);
        bg_off = BitmapFactory.decodeResource(getResources(), R.drawable.radiobuttonleft);
        slipper_btn = BitmapFactory.decodeResource(getResources(), R.drawable.buttonimage);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch(event.getAction()){
            ...
            case MotionEvent.ACTION_UP:{
                ...
                if(listener != null){
                    listener.OnChanged(SwicthView.this, nowStatus);
                }
                break;
            }
        }
