package com.example.cloudAndPurchasing.zhi;
...
/**
 * 正则类
 * Created by zhangpengtao on 2016/5/16 0016.
 */
public class Is {
    //手机号码正则判断
    public static boolean IsMoblieNo(String phone){
        Pattern p = Pattern.compile("^((13[0-9])|(14[5,7])|(15[0-9])|(17[0,1,3,6,7,8])|()|(18[0-9]))\\d{8}$");
