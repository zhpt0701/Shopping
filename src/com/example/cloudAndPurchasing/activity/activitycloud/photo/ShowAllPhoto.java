...
import com.example.cloudAndPurchasing.customcontrol.photocontol.ImageItem;
import com.example.cloudAndPurchasing.customcontrol.photocontol.PublicWay;
import com.example.cloudAndPurchasing.customcontrol.photocontol.Res;
...
public class ShowAllPhoto extends Activity {
	...
	private class CancelListener implements OnClickListener {// 取消按钮的监听
		public void onClick(View v) {
			...
			intent.setClass(mContext, ActivitySurce.class);
			startActivity(intent);
		}
	}
				...
				.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (isChecked) {
							...
							okButton.setText(Res.getString("unfinished")+"(" + Bimp.tempSelectBitmap.size()
									+ "/"+PublicWay.num+")");
						} else {
							button.setVisibility(View.GONE);
							Bimp.tempSelectBitmap.remove(dataList.get(position));
							okButton.setText(Res.getString("unfinished")+"(" + Bimp.tempSelectBitmap.size() + "/"+PublicWay.num+")");
						}
						isShowOkBt();
					}
				});
